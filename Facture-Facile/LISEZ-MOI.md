...
4. Mettre `index.html`, `style.css`, `app.js`, `radiateur.png` et `config.js` à la racine du dépôt GitHub Pages, puis ouvrir le site en HTTPS. La bibliothèque Supabase est chargée depuis jsDelivr.
